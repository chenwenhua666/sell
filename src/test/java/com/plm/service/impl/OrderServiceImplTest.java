...
public class OrderServiceImplTest {
    ...
    private final String ORDER_ID = "1539868802693464679";
    @Test
    public void create() throws Exception {

        OrderDTO orderDTO = new OrderDTO();
        orderDTO.setBuyerName("HUAHUA");
        orderDTO.setBuyerAddress("新泺大街");
    ...
    public void findOne() throws Exception {
        OrderDTO result = orderService.fondOne(ORDER_ID);
    ...
    public void cancel() throws Exception {
        OrderDTO orderDTO = orderService.fondOne(ORDER_ID);
